        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                foreach (ListViewItem item in listView1.Items)
                {
                    ...
                    {
                        if ((Convert.ToInt32(row.Cells["product_available"].Value.ToString()) - Convert.ToInt32(item.SubItems[2].Text.ToString())) >= 1)
                        {
                            f = 1;
                ...
                if (f == 0)
                {
                    ...
                    if (row.Cells["product_available"].Value.ToString() == "0")
                    {
                        MessageBox.Show("Empty!!!");
                        return;
                    }
